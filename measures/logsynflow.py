...
from torch.nn import BatchNorm2d, Conv2d, GroupNorm, Linear
from convnextzpadd import LayerNorm
import types
from typing import Union, Text

from .p_utils import get_layer_metric_array
from .utils import sum_arr
from . import measure
...
# LogSynflow
@measure('logsynflow', bn=True, mode='channel')
def compute_synflow_per_weight(net, device, inputs, targets, mode='param', remap: Union[Text, None] = 'log'):
    net = net.train()

    # Disable batch norm
    for layer in net.modules():
      if isinstance(layer, (_BatchNorm, BatchNorm2d, GroupNorm, LayerNorm)):
